...
#Direction = 1 moves upward to origin
...
STEP_pin = 23 # sends pulses to move the motor
...
#Direction = 1 moves toward origin (up)
GPIO.output(DIR_pin, 1)

# Step delay (adjust for speed - slower for higher microstepping)
STEPS = 300 # 200 steps = 1 full revolution in full step mode
delay = 0.0208 /16
